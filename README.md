...
```bash
# Linux x86_64
curl -fsSL https://github.com/mihai-valentin/swatch/releases/latest/download/swatch-v0.4.3-linux-x64.tar.gz | tar xz
sudo mv swatch /usr/local/bin/

# macOS (Apple Silicon or Intel)
curl -fsSL https://github.com/mihai-valentin/swatch/releases/latest/download/swatch-v0.4.3-macos-arm64.tar.gz | tar xz
sudo mv swatch /usr/local/bin/
```
